...
CREATE TABLE `vehicle` (
  ...
  CONSTRAINT `driver_mobile` FOREIGN KEY (`driver_mobile`) REFERENCES `driver` (`driver_mobile`)
...
INSERT INTO `vehicle` VALUES ('CA-3427','Car','Bajaj',728965412),('CAE-3457','Lorry','Toyota',778988111),('CBJ-2356','Bus','Susuki Alto',77879635);
