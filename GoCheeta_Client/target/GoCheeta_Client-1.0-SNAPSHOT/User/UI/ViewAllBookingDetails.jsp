        ...
        <tbody>
            ...
            <tr> 
                ...
                <td style="width:15%;text-align: center">
                    <a href="/GoCheeta_Client/User/UI/AddNewFeedback.jsp?id=<% out.print(user.getOrderId()); %>" class="btn btn-primary"style="width:80px;height:40px;text-align:center;margin-right:5px;">Update</a>
