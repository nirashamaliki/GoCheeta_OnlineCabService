  ...
  <div class="sidebar" style="background:#3a4c76;">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="/GoCheeta_Client/Admin/UI/ViewAllVehicleDriver.jsp" class="active">
  ...
  <section class="home-section">
    <nav style="background:#3a4c76;">
      <div class="sidebar-button"style="color:#ffffff;">
        ...
        <span class="dashboard"style="color:#ffffff;">Vehicle Details</span>
      </div>
      ...
      <div style="background:#FFF">
        ...
        <input type="text" id="myInput" onkeyup='tableSearch()' placeholder="Search Vehicle Number" style="padding:10px;width:40%;margin-left:50%;border-radius:30px;border: 2px solid #e7e7e7;padding: 12px 20px;
