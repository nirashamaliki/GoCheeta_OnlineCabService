...
public class ObjectFactory {
    ...
    private final static QName _DeleteCustomerResponse_QNAME = new QName("http://gocheeta/", "deleteCustomerResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "getCustomers")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "deleteCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "updateCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "updateCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "getCustomerbyId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "addCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "addCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "getCustomerbyIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gocheeta/", name = "deleteCustomerResponse")
