 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://gocheeta/", wsdlLocation = "http://localhost:6060/GoCheeta_Server/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://gocheeta/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6060/GoCheeta_Server/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://gocheeta/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gocheeta/", "NewWebServicePort"), NewWebService.class, features);
    }
