 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://gocheeta/", wsdlLocation = "http://localhost:6060/GoCheeta_Server/UserWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://gocheeta/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6060/GoCheeta_Server/UserWebService?wsdl");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://gocheeta/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gocheeta/", "UserWebServicePort"), UserWebService.class, features);
    }
